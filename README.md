...
参考材料 `DJI RM AWARD 2026 申请材料-南京航空航天大学金城学院-周勇宇-嵌入式.pdf` 记录了本工程的研发背景、实机表现和关键算法思路；当前 README 结合仓库源码与公开技术资料整理而成。
...
- 本仓库参考申请材料: `DJI RM AWARD 2026 申请材料-南京航空航天大学金城学院-周勇宇-嵌入式.pdf`
...
The PDF file `DJI RM AWARD 2026 申请材料-南京航空航天大学金城学院-周勇宇-嵌入式.pdf` is used as technical background for the design goals, field results, and algorithm rationale.
...
The reference PDF records the following historical test results:
